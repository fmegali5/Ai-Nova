...
import { MessageCircleIcon, MailIcon, LoaderIcon, LockIcon, Eye, EyeOff, AlertCircle } from "lucide-react";
import { Link, useSearchParams } from "react-router"; // ← غيّر من react-router-dom
...
function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (error === "email_exists") {
      setErrorMessage("This email is already registered with a password. Please login with your password.");
